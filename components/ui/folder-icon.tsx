...
const TONE: Record<NonNullable<Avatar["tone"]>, { bg: string; ring: string; fg: string }> = {
  violet: { bg: "#dde5f3", ring: "#FFFFFF", fg: "#0f1f4d" },
  ...
  return (
    <div className={cn("relative", className)} style={{ width: w, height: h }}>
      <svg
        ...
        width={w}
        height={h}
        className="block drop-shadow-[0_18px_30px_rgba(15,31,77,0.18)]"
        aria-hidden
      >
        <defs>
          ...
          <linearGradient id="folder-back" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#0f1f4d" />
            <stop offset="100%" stopColor="#060f30" />
          </linearGradient>
          <linearGradient id="folder-tab" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#7587b0" />
            <stop offset="100%" stopColor="#455d8a" />
          </linearGradient>
        ...
        <line x1="42" y1="64" x2="120" y2="64" stroke="#a9b6d4" strokeWidth="2" strokeLinecap="round" />
        <line x1="42" y1="76" x2="100" y2="76" stroke="#d8dfee" strokeWidth="2" strokeLinecap="round" />
        <line x1="42" y1="88" x2="140" y2="88" stroke="#d8dfee" strokeWidth="2" strokeLinecap="round" />

...
const FOLDERS: SpecialistFolder[] = [
  {
    ...
    blurb: "Histology, IHC, FISH, molecular, genomics.",
  },
  {
    key: "radiology",
    label: "Radiology",
    icon: <ScanLine className="h-3.5 w-3.5" />,
    blurb: "All imaging — MRI, CT, mammogram, PET.",
  },
  {
    key: "med-onc",
    label: "Medical oncology",
    icon: <Stethoscope className="h-3.5 w-3.5" />,
    blurb: "Diagnosis, staging, treatment, labs.",
  },
  {
    key: "nursing",
    label: "Nursing & intake",
    icon: <HeartPulse className="h-3.5 w-3.5" />,
    blurb: "Demographics, intake, vitals, patient-reported.",
  },
];
